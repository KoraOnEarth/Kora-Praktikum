<template>
    ...
    <div class="container">
      <div class="course">
        ...
        <br>
	      <p>Здесь мы встречаемся с терминами “класс”, “объект”, “экземпляр”, “поле”, “методы” и другие. Давайте разберемся на примере. 
          Допустим, создается программа по учету котов и кошек. 
          Соответственно, мы имеем дело с объектами “коты”, и было бы хорошо все данные, связанные с котами, объединить в единой целое. 
